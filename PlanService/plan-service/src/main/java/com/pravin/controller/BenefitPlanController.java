...
public class BenefitPlanController {
	...
	public BenefitPlanAssociation getPlansByUsername(@PathVariable("username") String username){
		return service.getAllPlansByUsername(username);
	}
	
	@PostMapping("/association")
	public void addBenefitPlanAssociation(@RequestBody BenefitPlanAssociation dto) throws NotFoundException {
		service.addBenefitPlanAssociation(dto);
	}
}
